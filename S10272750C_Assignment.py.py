...
def use_portal_stone(player):
    if player['last_x'] is 1 and player['last_y'] is 1:
...
def enter_mine(player, game_map, fog):
    player['x'] = player.get('last_x', 1)
    player['y'] = player.get('last_y', 1)
    clear_fog(fog, player)
...
while True:
    ...
    while True:
        ...
        # enter the mine
            ...
            enter_mine(player, game_map, fog)
            while True:
                draw_map(game_map, fog, player)
